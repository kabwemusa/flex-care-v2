...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('med_discount_cards', function (Blueprint $table) {
            $table->id();
            // Null plan_id means it applies to ALL schemes (Global Discount)
            $table->foreignId('plan_id')->nullable()->constrained('med_plans')->onDelete('cascade');
            ...
            $table->decimal('value', 15, 2);  // e.g., 5.00 (percent) or 500.00 (fixed)
            
            // The JSON Rule Engine
            // Example: {"field": "frequency", "operator": "=", "value": "annual"}
